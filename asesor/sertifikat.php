...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['generate_id'])) {
    ...
    if (!$det) {
        ...
        if ($cek->get_result()->fetch_assoc()) {
            ...
            $nomor = generateCertificateNumber($koneksi, $idPendaftaran);
...
<body>
    ...
    <!-- SIDEBAR -->
    <div class="sidebar">
        <h2 class="d-none d-md-block text-center" style="margin-top: 37px; margin-bottom: 50px; color:#b597ff">RELIPROVE</h2>
    ...
    <div class="content">
        <div class="topbar">
            ...
            <div style="display:flex;align-items:center;gap:10px;">
                <?php $namaUser = $_SESSION['nama'] ?? 'Asesor'; ?>
            ...
            <div class="kc-grid">
                ...
                ?>
                        <div class="kc-card">
                            ...
                            <!-- FOOT -->
                            <div class="kc-foot">
                                <a class="btn-ghost" href="daftar_penilaian.php?detail=<?= (int)$r['id_pendaftaran'] ?>"><i class="fa-regular fa-eye"></i> Detail</a>
